  ...
  return (
    <div className='h-[100vh]'>
      <div className='flex p-20' >
        <div className='relative h-[80vh] rounded-l-lg flex justify-center items-center w-3/5 font-sans text-primary-content'>
          <div
        ...
        <div className='h-[80vh] rounded-r-lg w-2/5 bg-neutral flex justify-center items-center'>
